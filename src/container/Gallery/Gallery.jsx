  ...
  return (
    <div className='app__gallery flex__center'>
      <div className='app__gallery-content'>
        ...
        <h1 className="headtext__cormorant">Gallerie Photo</h1>
        <p className='p__opensans' style={{color: '#AAA', marginTop: '2rem'}}>Abonnez-vous à notre Instagram pour ne pas louper les nouveautés</p>
